const colorData = {
      '1': {
        sakuraText: `Ein Hauch Kirschblüte. Für Momente, die dir gehören.<br>Inspiriert von der japanischen Sakura-Tradition vereint diese Kollektion <strong>natürliche Baumwolle und Duft</strong> zu einem einzigen, bewussten Moment. Der feine Aroma von Reismilch und Kirschblüte umhüllt dich sanft – und erinnert dich mit jedem Atemzug daran, <strong>innezuhalten</strong>. Durchatmen. Neu starten.`,
        mosaicCaption: `Damit dein Ritual auch nach der Wäsche weiterlebt: Jeder Lieferung liegen exklusive Proben der Sakura-Wäschepflege bei – feine Duftperlen und sanfte Tabs, die die Fasern deines Tuches bei jeder Wäsche neu beleben. Der zarte Hauch von Kirschblüte und Reismilch bleibt. Immer wieder.`,
        images: {
      ...
      '2': {
        sakuraText: `Ein Hauch süßer Orange. Wärme, die bleibt.<br>Inspiriert von der Sonne als Kraft des Lebens vereint diese Kollektion <strong>Textil und Duft</strong> zu einem einzigen, leuchtenden Ritual. Das warme Aroma von süßer Orange und Zedernholz umhüllt dich sanft – und erinnert dich mit jedem Atemzug daran, <strong>innezuhalten</strong>. Licht finden. Strahlen.`,
        mosaicCaption: `Damit dein Ritual auch nach der Wäsche weiterlebt: Jeder Lieferung liegen exklusive Proben der Sakura-Wäschepflege bei – feine Duftperlen und sanfte Tabs, die die Fasern deines Tuches bei jeder Wäsche neu beleben. Die warme Note von Orange und Zedernholz bleibt. Immer wieder.`,
        images: {
